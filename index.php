...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="assets/img/168897511070427.image_cropper_1688975098932_large.jpg" alt="" data-aos="fade-in">

      <div class="container">
        <h2 data-aos="fade-up" data-aos-delay="100">Ayo Bermain dan<br>
        Berolahraga di <span class="text-"> Dunia</span> <br> Futsal</h2>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2 my-auto" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/168897511070427.image_cropper_1688975098932_large.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
            <h3>Dunia Futsal Hadir Untuk Anda</h3>
            <p class="fst-italic">
              Nikmati pengalaman berolahraga terbaik dengan sarana premium yang kami sediakan.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Fasilitas olahraga modern dan lengkap.</span></li>
              <!-- <li><i class="bi bi-check-circle"></i> <span>Pelatih Profesional.</span></li> -->
              <li><i class="bi bi-check-circle"></i> <span>Lapangan Bersih.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Lingkungan Aman.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Bebas Toxic.</span></li>
            </ul>
          </div>
